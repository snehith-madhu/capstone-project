...
def my_task(c):
    ...
    c.run('conda activate env_project_demo-dev')
...
def code_complexity(c):
    ...
    # Run Radon to calculate code complexity
    result = c.run(f'radon cc -s {codebase_path}', hide=True, warn=True)

    # Print the Radon result (you can modify the output as needed)
    print(result.stdout)
_create_task_collection(
    "complexity",
    code_complexity
